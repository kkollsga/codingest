...
pub(super) fn selectors_df(selectors: &[crate::models::SelectorInfo]) -> DataFrame {
    build_df(vec![
        (
            "qualified_name",
            ColumnType::String,
...
pub(super) fn element_contains_edges_df(elements: &[crate::models::ElementInfo]) -> DataFrame {
