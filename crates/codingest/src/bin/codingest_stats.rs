...
//!
//! Usage:
//!   cargo run -p code-tree --bin code_tree_stats --release -- <path>
//!   cargo run -p code-tree --bin code_tree_stats --release -- <path> --include-tests
//!   cargo run -p code-tree --bin code_tree_stats --release -- <path> --function-metrics
